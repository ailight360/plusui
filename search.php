...
<span class="hm" data-text="<?php echo $opt_themes['opts_title_other_2']; ?>"></span>
...
<div class="blogPts mty">
			...
			<span><?php echo $opt_themes['opts_title_other_15']; ?> "<?php echo get_search_query(); ?>" <?php echo $opt_themes['opts_title_other_16']; ?> </span>
			</div>
			</div>
			</div>
<?php } ?>
